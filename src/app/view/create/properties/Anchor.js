...
const Anchor = props => {
    ...
    const icon = value => {
        if (value === 'left') {
            return <ArrowLeft sx={{fontSize: 15, color: isActive(value) ? primaryColor : fontColor}} />;
        } else if (value === 'top') {
            return <ArrowDropUp sx={{fontSize: 15, color: isActive(value) ? primaryColor : fontColor}} />;
        } else if (value === 'right') {
            return <ArrowRight sx={{fontSize: 15, color: isActive(value) ? primaryColor : fontColor}} />;
        } else {
            return <ArrowDropDown sx={{fontSize: 15, color: isActive(value) ? primaryColor : fontColor}} />;
        }
    };
